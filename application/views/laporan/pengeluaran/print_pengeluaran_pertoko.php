          ...
          <table class="change_order_items" style="font-family: Calibri; font-size: 10pt; border: 1px dotted; width: 100%;">
            <tbody>
              <tr>
                ...
                <th style="border-bottom: 1px dotted; text-align: center;">Kode Permintaan</th>
              ...
              foreach ($lines as $line) : ?>
                <tr>
                  ...
                  <td style="text-align: left; "><?= $line->supplier; ?></td>
                  <td style="text-align: center;"><?= $line->kodepermintaan; ?></td>
