<div class="row">
  <div class="col-md-12">
    <div class="card shadow">
      <div class="card-header">
        <div class="row">
          <div class="col-md-6 mt-1">
            <h6 class="m-0 font-weight-bold text-primary">Pengeluaran Overall</h6>
          </div>
      ...
      <form action="<?= base_url('laporan/print-pengeluaran-overall'); ?>" method="post" id="formFilter" target="_blank" style="display: none;">
