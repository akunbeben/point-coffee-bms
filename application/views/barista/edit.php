      ...
      <div class="card-body">
        <form action="" method="post">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nik" name="nik" value="<?= $barista->nik; ?>">
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="jenis_kelamin" name="jenis_kelamin">
              <?php foreach ($jenis_kelamin as $jenis) : ?>
                <option value="<?= $jenis->desc ?>" <?= $jenis->desc == $barista->jenis_kelamin ? 'selected' : '' ?>><?= $jenis->desc ?></option>
              <?php endforeach; ?>
            </select>
          </div>
          <div class="form-group">
            ...
            <select class="form-control" id="jabatan" name="jabatan">
              <?php foreach ($jabatan as $jbtn) : ?>
                <option value="<?= $jbtn->desc ?>" <?= $jbtn->desc == $barista->jabatan ? 'selected' : '' ?>><?= $jbtn->desc ?></option>
              <?php endforeach; ?>
            </select>
          </div>
          <div class="form-group">
            <label for="alamat">Alamat</label>
            <textarea type="text" class="form-control" id="alamat" name="alamat"><?= $barista->alamat; ?></textarea>
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="status_kerja" name="status_kerja">
              <?php foreach ($status_kerja as $status) : ?>
                <option value="<?= $status->desc ?>" <?= $status->desc == $barista->status_kerja ? 'selected' : '' ?>><?= $status->desc ?></option>
              <?php endforeach; ?>
            </select>
          </div>
          <div class="form-group">
            ...
            <select class="form-control" id="status_perkawinan" name="status_perkawinan">
              <?php foreach ($status_perkawinan as $perkawinan) : ?>
                <option value="<?= $perkawinan->desc ?>" <?= $perkawinan->desc == $barista->status_perkawinan ? 'selected' : '' ?>><?= $perkawinan->desc ?></option>
              <?php endforeach; ?>
            </select>
          </div>
