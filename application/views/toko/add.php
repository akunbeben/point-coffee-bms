            ...
            <div class="card-body">
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="kodetoko" name="kodetoko">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="buka" name="buka">
                    </div>
                    <div class="form-group">
                        <label for="namafrc">Nama Perusahaan</label>
                        <input type="text" class="form-control" id="namafrc" name="namafrc">
                    </div>
                    <div class="form-group">
