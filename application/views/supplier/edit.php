            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="alamat1" name="alamat1" value="<?= $supplier->alamat1; ?>">
                    </div>
                    <div class="form-group">
                        <label for="alamat2">Alamat Cabang</label>
                        <input type="text" class="form-control" id="alamat2" name="alamat2" value="<?= $supplier->alamat2; ?>">
                    </div>
                    <div class="form-group">
                        <label for="telp1">Telp Pusat</label>
                        <input type="text" class="form-control" id="telp1" name="telp1" value="<?= $supplier->telp1; ?>">
                    </div>
                    <div class="form-group">
                        <label for="telp2">Telp Cabang</label>
                        <input type="text" class="form-control" id="telp2" name="telp2" value="<?= $supplier->telp2; ?>">
                    </div>
